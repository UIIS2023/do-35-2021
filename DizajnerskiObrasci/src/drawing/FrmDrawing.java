...
public class FrmDrawing extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					e.printStackTrace(); //throwuje error ukoliko se desi
				}
			}
		});
	}
	...
	public FrmDrawing() {
		...
		setBounds(100, 100, 582, 359);
		setResizable(true); //da korisnik ne mo�e//mo�e da menja size app
		...
		btnGroup.add(tglbtnPoint); //ukoliko ne bi ovo odradio nece se deselektovati kada posle kliknes na line
